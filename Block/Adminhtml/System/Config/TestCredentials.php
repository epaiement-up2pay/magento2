...
namespace CreditAgricole\PaymentGateway\Block\Adminhtml\System\Config;

/**
 * Class TestCredentials
 * @package CreditAgricole\PaymentGateway\Block\Adminhtml\System\Config
 * @since 3.0.0
 */
class TestCredentials extends \Magento\Config\Block\System\Config\Form\Field
{
    const TEST_CREDENTIALS_TEMPLATE = 'CreditAgricole_PaymentGateway::system/config/test_credentials.phtml';

    const TEST_CREDENTIALS_CONTROLLER_PATH = 'CreditAgricole_PaymentGateway/test/credentials';
